...
# --- СПАВН КРАСНЫХ (исправлен: 18 64 -817) ---
...
# --- Дымовые гранаты всем по командам ---
...
# --- ПТУР одному синему (тег — оба предмета одному) ---
...
# --- Компас случайному красному ---
tag @a[team=red,limit=1,sort=random] add fl_navigator
give @a[tag=fl_navigator] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:37,Y:62,Z:-406},LodestoneTracked:1b} 1
tag @a remove fl_navigator

# ================================================
# БМП-2: спавн на базе красных (24 64 -819)
# ================================================
...
tellraw @a[team=red] [{"text":"[ZOV] ","color":"red","bold":true},{"text":"Компас выдан случайному игроку — держите в руке для навигации!","color":"yellow"}]