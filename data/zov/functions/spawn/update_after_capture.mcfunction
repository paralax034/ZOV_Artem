...
# Красные → на захваченную точку (с проверкой #a1_variant)
# Синие   → на следующую (новую активную)
# 

#  КРАСНЫЕ: спавн на только что захваченной точке 
execute if score #global fl_active matches 1 if score #a1_variant fl_math matches 0 run spawnpoint @a[team=red] 37 72 -406
execute if score #global fl_active matches 1 if score #a1_variant fl_math matches 1 run spawnpoint @a[team=red] -57 71 -414
