...
execute if score #global fl_active matches 2 run give @a[team=blue] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:-5,Y:71,Z:-280},LodestoneTracked:0b,display:{Name:'{"text":"→ A2 | Защищать","color":"aqua","bold":true,"italic":false}'}}
...
execute if score #global fl_active matches 3 run give @a[tag=fl_navigator] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:-186,Y:54,Z:-164},LodestoneTracked:0b,display:{Name:'{"text":"→ A3 | Захватить","color":"red","bold":true,"italic":false}'}}
execute if score #global fl_active matches 3 run clear @a[team=blue] minecraft:compass
execute if score #global fl_active matches 3 run give @a[team=blue] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:-186,Y:54,Z:-164},LodestoneTracked:0b,display:{Name:'{"text":"→ A3 | Защищать","color":"aqua","bold":true,"italic":false}'}}
...
execute if score #global fl_active matches 4 run give @a[tag=fl_navigator] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:-404,Y:55,Z:-286},LodestoneTracked:0b,display:{Name:'{"text":"→ A4 | Захватить","color":"red","bold":true,"italic":false}'}}
execute if score #global fl_active matches 4 run clear @a[team=blue] minecraft:compass
execute if score #global fl_active matches 4 run give @a[team=blue] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:-404,Y:55,Z:-286},LodestoneTracked:0b,display:{Name:'{"text":"→ A4 | Защищать","color":"aqua","bold":true,"italic":false}'}}
...
execute if score #global fl_active matches 5 run give @a[tag=fl_navigator] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:-412,Y:55,Z:58},LodestoneTracked:0b,display:{Name:'{"text":"→ A5 | Захватить","color":"red","bold":true,"italic":false}'}}
execute if score #global fl_active matches 5 run clear @a[team=blue] minecraft:compass
execute if score #global fl_active matches 5 run give @a[team=blue] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:-412,Y:55,Z:58},LodestoneTracked:0b,display:{Name:'{"text":"→ A5 | Защищать","color":"aqua","bold":true,"italic":false}'}}
...
execute if score #global fl_active matches 6 run give @a[tag=fl_navigator] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:-171,Y:54,Z:122},LodestoneTracked:0b,display:{Name:'{"text":"→ A6 | Захватить","color":"red","bold":true,"italic":false}'}}
execute if score #global fl_active matches 6 run clear @a[team=blue] minecraft:compass
execute if score #global fl_active matches 6 run give @a[team=blue] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:-171,Y:54,Z:122},LodestoneTracked:0b,display:{Name:'{"text":"→ A6 | Защищать","color":"aqua","bold":true,"italic":false}'}}
...
execute if score #global fl_active matches 7 run give @a[tag=fl_navigator] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:312,Y:90,Z:211},LodestoneTracked:0b,display:{Name:'{"text":"→ ЗАВОД A7 | Захватить","color":"red","bold":true,"italic":false}'}}
execute if score #global fl_active matches 7 run clear @a[team=blue] minecraft:compass
execute if score #global fl_active matches 7 run give @a[team=blue] minecraft:compass{LodestoneDimension:"minecraft:overworld",LodestonePos:{X:312,Y:90,Z:211},LodestoneTracked:0b,display:{Name:'{"text":"→ ЗАВОД A7 | Защищать","color":"aqua","bold":true,"italic":false}'}}