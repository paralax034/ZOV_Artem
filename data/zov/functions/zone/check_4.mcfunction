# 
# ЗОНА A4 (-407 49 -289 -> -401 82 -283) | Y expanded +-15
# 

execute store result score #red_here fl_math if entity @a[team=red,tag=!fl_waiting,x=-407,y=49,z=-289,dx=6,dy=33,dz=6]
execute store result score #blue_here fl_math if entity @a[team=blue,tag=!fl_waiting,x=-407,y=49,z=-289,dx=6,dy=33,dz=6]
