...
execute store result score #red_here fl_math run execute if entity @a[team=red,tag=!fl_waiting,x=310,y=99,z=208,dx=5,dy=2,dz=6]
execute store result score #blue_here fl_math run execute if entity @a[team=blue,tag=!fl_waiting,x=310,y=99,z=208,dx=5,dy=2,dz=6]
