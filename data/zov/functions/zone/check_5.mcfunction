...
execute store result score #red_here fl_math run execute if entity @a[team=red,tag=!fl_waiting,x=-423,y=63,z=48,dx=21,dy=5,dz=21]
execute store result score #blue_here fl_math run execute if entity @a[team=blue,tag=!fl_waiting,x=-423,y=63,z=48,dx=21,dy=5,dz=21]
