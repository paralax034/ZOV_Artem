# 
# ЗОНА A2 (-11 57 -289 -> 0 105 -272) | Y expanded +-15
# 

execute store result score #red_here fl_math if entity @a[team=red,tag=!fl_waiting,x=-11,y=57,z=-289,dx=11,dy=48,dz=17]
execute store result score #blue_here fl_math if entity @a[team=blue,tag=!fl_waiting,x=-11,y=57,z=-289,dx=11,dy=48,dz=17]
