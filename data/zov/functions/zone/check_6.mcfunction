...
execute store result score #red_here fl_math run execute if entity @a[team=red,x=-174,y=63,z=119,dx=6,dy=3,dz=6]
execute store result score #blue_here fl_math run execute if entity @a[team=blue,x=-174,y=63,z=119,dx=6,dy=3,dz=6]
