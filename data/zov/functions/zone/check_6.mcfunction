# 
# ЗОНА A6 (-174 48 119 -> -168 81 125) | Y expanded +-15
# 

execute store result score #red_here fl_math if entity @a[team=red,tag=!fl_waiting,x=-174,y=48,z=119,dx=6,dy=33,dz=6]
execute store result score #blue_here fl_math if entity @a[team=blue,tag=!fl_waiting,x=-174,y=48,z=119,dx=6,dy=33,dz=6]
