# 
# ЗОНА A3 (-192 48 -169 -> -181 81 -160) | Y expanded +-15
# 

execute store result score #red_here fl_math if entity @a[team=red,tag=!fl_waiting,x=-192,y=48,z=-169,dx=11,dy=33,dz=9]
execute store result score #blue_here fl_math if entity @a[team=blue,tag=!fl_waiting,x=-192,y=48,z=-169,dx=11,dy=33,dz=9]
