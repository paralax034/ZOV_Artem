...
execute store result score #red_here fl_math run execute if entity @a[team=red,tag=!fl_waiting,x=-192,y=63,z=-169,dx=11,dy=3,dz=9]
execute store result score #blue_here fl_math run execute if entity @a[team=blue,tag=!fl_waiting,x=-192,y=63,z=-169,dx=11,dy=3,dz=9]
